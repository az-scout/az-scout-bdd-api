...
async def v1_status() -> JSONResponse:
    ...
    from az_scout_bdd_api.db_api import get_status
...
async def v1_locations(
    ...
    from az_scout_bdd_api.db_api import list_locations
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_limit
...
async def v1_skus(
    ...
    from az_scout_bdd_api.db_api import list_skus
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_limit
...
async def v1_currencies(
    ...
    from az_scout_bdd_api.db_api import list_currencies
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_limit
...
async def v1_os_types(
    ...
    from az_scout_bdd_api.db_api import list_os_types
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_limit
...
async def v1_retail_prices(
    ...
    from az_scout_bdd_api.db_api import list_retail_prices
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_iso_dt, parse_limit
...
async def v1_retail_prices_latest(
    ...
    from az_scout_bdd_api.db_api import list_retail_prices_latest
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_iso_dt, parse_limit
...
async def v1_spot_prices(
    ...
    from az_scout_bdd_api.db_api import list_spot_prices
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_limit, validate_sample
...
async def v1_eviction_rates(
    ...
    from az_scout_bdd_api.db_api import list_eviction_rates
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_iso_dt, parse_limit
...
async def v1_eviction_rates_series(
    ...
    from az_scout_bdd_api.db_api import eviction_rate_series
    from az_scout_bdd_api.validation import (
        ValidationError,
        validate_agg,
        validate_bucket,
    )
...
async def v1_eviction_rates_latest(
    ...
    from az_scout_bdd_api.db_api import list_eviction_rates_latest
    from az_scout_bdd_api.validation import ValidationError, parse_iso_dt, parse_limit
...
async def v1_pricing_categories(
    ...
    from az_scout_bdd_api.db_api import list_pricing_categories
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_limit
...
async def v1_pricing_summary(
    ...
    from az_scout_bdd_api.db_api import list_pricing_summary
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_iso_dt, parse_limit
...
async def v1_pricing_summary_latest(
    ...
    from az_scout_bdd_api.db_api import list_pricing_summary_latest
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_limit
...
async def v1_pricing_summary_cheapest(
    ...
    from az_scout_bdd_api.db_api import list_pricing_cheapest
    from az_scout_bdd_api.validation import (
        ValidationError,
        validate_metric,
        validate_price_type,
...
async def v1_sku_catalog(
    ...
    from az_scout_bdd_api.db_api import list_sku_catalog
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_limit
...
async def v1_jobs(
    ...
    from az_scout_bdd_api.db_api import list_jobs
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import (
        ValidationError,
        parse_limit,
...
async def v1_job_logs(
    ...
    from az_scout_bdd_api.db_api import list_job_logs
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import (
        ValidationError,
        parse_limit,
...
async def v1_spot_prices_series(
    ...
    from az_scout_bdd_api.db_api import spot_price_series
    from az_scout_bdd_api.validation import (
        ValidationError,
        validate_pricing_bucket,
    )
...
async def v1_retail_prices_compare(
    ...
    from az_scout_bdd_api.db_api import retail_prices_compare
    from az_scout_bdd_api.validation import ValidationError, parse_iso_dt
...
async def v1_spot_detail(
    ...
    from az_scout_bdd_api.db_api import spot_detail
    from az_scout_bdd_api.validation import ValidationError, parse_iso_dt
...
async def v1_savings_plans(
    ...
    from az_scout_bdd_api.db_api import list_savings_plans
    from az_scout_bdd_api.pagination import InvalidCursorError, build_page, decode_cursor
    from az_scout_bdd_api.validation import ValidationError, parse_iso_dt, parse_limit
...
async def v1_stats() -> JSONResponse:
    ...
    from az_scout_bdd_api.db_api import get_global_stats
