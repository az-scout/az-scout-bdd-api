...
from az_scout_bdd_api.routes import router
...
class TestV1Status:
    @patch(
        "az_scout_bdd_api.db_api.get_status",
...
class TestV1Locations:
    @patch(
        "az_scout_bdd_api.db_api.list_locations",
        new_callable=AsyncMock,
...
class TestV1Skus:
    @patch(
        "az_scout_bdd_api.db_api.list_skus",
        new_callable=AsyncMock,
...
class TestV1Currencies:
    @patch(
        "az_scout_bdd_api.db_api.list_currencies",
        new_callable=AsyncMock,
...
class TestV1OsTypes:
    @patch(
        "az_scout_bdd_api.db_api.list_os_types",
        new_callable=AsyncMock,
...
class TestV1RetailPrices:
    ...
    @patch("az_scout_bdd_api.db_api.list_retail_prices", new_callable=AsyncMock)
    def test_happy_path(self, mock_fn: AsyncMock, client: TestClient) -> None:
...
class TestV1RetailPricesLatest:
    ...
    @patch("az_scout_bdd_api.db_api.list_retail_prices_latest", new_callable=AsyncMock)
    def test_happy_path(self, mock_fn: AsyncMock, client: TestClient) -> None:
        mock_fn.return_value = (
            [
                {
...
class TestV1SpotPrices:
    @patch("az_scout_bdd_api.db_api.list_spot_prices", new_callable=AsyncMock)
...
class TestV1EvictionRates:
    ...
    @patch("az_scout_bdd_api.db_api.list_eviction_rates", new_callable=AsyncMock)
    def test_happy_path(self, mock_fn: AsyncMock, client: TestClient) -> None:
        mock_fn.return_value = (
            [
                {
...
class TestV1EvictionRatesSeries:
    @patch("az_scout_bdd_api.db_api.eviction_rate_series", new_callable=AsyncMock)
    def test_happy_path(self, mock_fn: AsyncMock, client: TestClient) -> None:
        mock_fn.return_value = [
...
class TestV1EvictionRatesLatest:
    ...
    @patch("az_scout_bdd_api.db_api.list_eviction_rates_latest", new_callable=AsyncMock)
    def test_happy_path(self, mock_fn: AsyncMock, client: TestClient) -> None:
        mock_fn.return_value = (
            [
                {
...
class TestV1RetailPricesCompare:
    ...
    @patch("az_scout_bdd_api.db_api.retail_prices_compare", new_callable=AsyncMock)
    def test_happy_path(self, mock_fn: AsyncMock, client: TestClient) -> None:
        mock_fn.return_value = (
            [
...
class TestV1SpotDetail:
    ...
    @patch("az_scout_bdd_api.db_api.spot_detail", new_callable=AsyncMock)
    def test_happy_path(self, mock_fn: AsyncMock, client: TestClient) -> None:
        mock_fn.return_value = (
...
class TestV1SavingsPlans:
    ...
    @patch("az_scout_bdd_api.db_api.list_savings_plans", new_callable=AsyncMock)
    def test_happy_path(self, mock_fn: AsyncMock, client: TestClient) -> None:
        mock_fn.return_value = (
            [
                {
